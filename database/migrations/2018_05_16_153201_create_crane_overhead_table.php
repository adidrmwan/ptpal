...
class CreateCraneOverheadTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('crane_overhead', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->integer('checklist_14');
            $table->integer('checklist_15');
            $table->integer('checklist_16');
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('crane_overhead');
    }
}
